...
export interface SearchParams {
  ...
  citationTrailFilterByAvailability? : boolean,
  isRAsearch?: boolean,
  isNaturalLanguageSearch?: boolean,
  featuredNewspapersIssnList?:string,
  journals?: string,
  databases?: string,
  entityName?: string,
  lang?:string,
...
export interface CitationTrailsTile {
  recordId: string;
  title:   string;
  author: string;
  type: string;
